...
vcff_map_field(array(
    'type' => 'ch_multi_choice',
    'title' => 'CH - Multiple Choice',
    'class' => 'CH_Fields_Multiple_Choice_Item',
    'filter_logic' => array(),
    ...
    'vc_map' => array(
        'params' => array(
            ...
            array (
                ...
                'group' => __('Question',VCFF_FORM),
                'description' => __('Enter the answer number. For multiple possible correct answers, seperate each number by a comma. For example; 2,4,5. For multiple answer groups seperate each group with a | character. For example; 2,4,5|2,1|3,1')
            ),
            array(
                "type" => "checkbox",

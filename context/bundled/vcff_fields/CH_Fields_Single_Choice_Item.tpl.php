<div data-vcff-field-name="<?php echo $machine_code; ?>" class="vcff-field ch-field ch-single-choice-field <?php echo $extra_class; ?> <?php echo $css_class; ?>" <?php if ($this->Is_Hidden()): ?>style="display:none;"<?php endif; ?>>
    ...
    <div class="radio">
        <label>
            <input type="radio" name="<?php echo $machine_code; ?>" value="<?php echo $_input['i']; ?>" <?php if ($this->Is_Locked()): ?>disabled="disabled"<?php endif; ?> <?php if ($this->posted_value == $_input['i']): ?>checked="checked"<?php endif; ?> <?php echo $attributes; ?> <?php if ($is_disabled == 'yes'): ?> disabled="disabled"<?php endif; ?> class="<?php if ($this->Has_Dependents()): ?>check-change<?php endif; ?> <?php echo $field_extra_class; ?>">

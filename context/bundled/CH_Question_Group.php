...
class CH_Question_Group {
    
    static $container_type = 'ch_question_group';
    
    static $container_title = 'CH - Question Group';

    static $item_class = 'CH_Question_Group_Item';
        ...
        return array(
            'params' => array(
                ...
                array (
                    ...
                    'group' => __('Questions',VCFF_FORM),
                    'html_title' => 'Questions Setup',
                    'html_description' => 'You can set this field to accept dynamic values from either POST, GET or REQUEST variables. This is useful if you have forms posting to each other or if you want to refill form fields via a URL link.',
                ),
                array(
                    "type" => "textfield",
                    "heading" => __("Number of questions to show", VCFF_NS),
                    "param_name" => "ch_questions_number",
                    'group' => __('Questions',VCFF_FORM),
                ),
                array(
                    "type" => "checkbox",
                   // "heading" => __("Number of questions to show", VCFF_NS),
                    "param_name" => "ch_randomise_questions",
                    'group' => __('Questions',VCFF_FORM),
                    'value' => array(
...
class WPBakeryShortCode_CH_Question_Group extends WPBakeryShortCodesContainer {
...
vcff_map_container('CH_Question_Group');
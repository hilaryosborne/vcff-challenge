...
class CH_Fields_Matching extends CH_Question_Item {
    
    static $field_type = 'ch_matching';
    
    static $field_title = 'CH - Matching';

    static $item_class = 'CH_Fields_Matching_Item';
    ...
    static function VC_Params() {
        ...
        return array(
            'params' => array(
                ...
                array (
                    "type" => "textarea_raw_html",
                    "heading" => __ ("Extra wrong options", VCFF_FORM ),
                    'group' => __('Question',VCFF_FORM),
...
vcff_map_field('CH_Fields_Matching');
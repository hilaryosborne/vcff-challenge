...
class CH_Fields_Fill_Blanks extends CH_Question_Item {
    
    static $field_type = 'ch_fill_blanks';
    
    static $field_title = 'CH - Fill in the Blanks';

    static $item_class = 'CH_Fields_Fill_Blanks_Item';
...
vcff_map_field('CH_Fields_Fill_Blanks');
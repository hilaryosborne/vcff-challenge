...
class CH_Fields_Essay {
    
    static $field_type = 'ch_essay_answer';
    
    static $field_title = 'CH - Essay Answer';

    static $item_class = 'CH_Fields_Essay_Item';
...
vcff_map_field('CH_Fields_Essay');
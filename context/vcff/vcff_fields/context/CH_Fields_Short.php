...
class CH_Fields_Short {
    
    static $field_type = 'ch_short_answer';
    
    static $field_title = 'CH - Short Answer';

    static $item_class = 'CH_Fields_Short_Item';
...
vcff_map_field('CH_Fields_Short');
...
class CH_Fields_Multiple_Choice extends CH_Question_Item {
    
    static $field_type = 'ch_multi_choice';
    
    static $field_title = 'CH - Multiple Choice';

    static $item_class = 'CH_Fields_Multiple_Choice_Item';
...
vcff_map_field('CH_Fields_Multiple_Choice');